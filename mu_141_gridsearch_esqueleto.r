...
# cargo los datos
dataset <- fread("C:Users/marti/oneDrive/Documentos/Data Science Maestria/laboratorio/labo2023ba/datasets_dataset_pequeno.csv")
...
# read csv
dataset <- read.csv("C:/Users/marti/OneDrive/Documentos/Data Science Maestria/laboratorio/labo2023ba/datasets_dataset_pequeno.csv")
