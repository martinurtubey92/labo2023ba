...
PARAM <- list()
PARAM$experimento <- "DR12"

PARAM$exp_input <- "CA612"

PARAM$variables_intrames <- FALSE # VARIABLE DE CORTE INTERESANTE PROBAR CON FALSE Y DEFLACION A PRIORI NO SUMA NADA, 

# valores posibles
#  "ninguno", "rank_simple", "rank_cero_fijo", "deflacion", "estandarizar"
PARAM$metodo <- "deflacion"#es el metodo que arrojo mejores resultados en crudo 
