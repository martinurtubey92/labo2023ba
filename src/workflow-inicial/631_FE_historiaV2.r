...
PARAM <- list()
PARAM$experimento <- "FE13"

PARAM$exp_input <- "DR13"

PARAM$lag1 <- FALSE #ACTIVO EL LAG 1- EN LA VERSION ANTERIOR LO TENIA DESACTIVADO
PARAM$lag2 <- TRUE
PARAM$lag3 <- TRUE
...
PARAM$Tendencias2$ventana <- 6 #CAMBIADO A 6 NUEVAMENTE 
...
PARAM$RandomForest$semilla <- 100049 # cambiar por la propia semilla


# varia de 0.0 a 2.0, si es 0.0 NO se activan
PARAM$CanaritosAsesinos$ratio <- 2.0 #cambiado segun prueba del equipo
# desvios estandar de la media, para el cutoff
PARAM$CanaritosAsesinos$desvios <- 0.10 # me parece muy alto 0.5 creo que esta overfietenado veremos yo uso 0.25
# cambiar por la propia semilla
PARAM$CanaritosAsesinos$semilla <- 100049
