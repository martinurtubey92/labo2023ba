...
PARAM <- list()
PARAM$experimento <- "TS13"

PARAM$exp_input <- "FE13"

# me salteo los meses duros de pandemia, pero llego hasta 201907 en training
# entreno en 18 meses
# CONFORME A AL EXPERIMENTO COLABORATIVO NUMERO 7 SE DEJAN AFUERA LOS MESES DE PANDEMIA 
...
PARAM$train$testing <- c(202107) #CONFORME A EXPERIMENTO NUMERO 8 INTERENSANTE INCLUIR 07 -VUELVO A LOS PARAMETROS ORIGINALES 
...
PARAM$train$undersampling <- 0.6 # TOMO EL DEL EQUIPO B PROBAR LUEGO ALTERNATIVA 

PARAM$train$semilla <- 100049 # cambiar por su propia semilla  !!!
